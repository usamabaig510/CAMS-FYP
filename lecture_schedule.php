...
<nav class="navbar navbar-expand-lg navbar-dark">
  ...
  <h1 class="text-center fw-bold my-3">Lecture Schedule</h1>
  <div class="container mt-5">
    
      
      <div class="alert alert-warning text-center">
        <h4 class="fw-bold">You're not admitted right now!</h4>
        <p>There is no lecture schedule available for you at the moment.</p>
      </div>
